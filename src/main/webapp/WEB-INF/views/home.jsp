                ...
                <div class="panel panel-red">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-xs-9 text-right entity">
                                <div class="huge count">${productItems.count()}</div>
                                <div class="title">ProductItems</div>
                            </div>
                        </div>
                    </div>
                    <a href="${appPath}/productItems/list">
                        <div class="panel-footer">
                            <span class="pull-left">View Details</span>
                            <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                            <div class="clearfix"></div>
                ...
                <div class="panel panel-yellow">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-xs-9 text-right entity">
                                <div class="huge count">${userRole.count()}</div>
                                <div class="title">UserRole</div>
                            </div>
                        </div>
                    </div>
                    <a href="${appPath}/userRole/list">
                        <div class="panel-footer">
                            <span class="pull-left">View Details</span>
                            <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                            <div class="clearfix"></div>
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-xs-9 text-right entity">
                                <div class="huge count">${group1.count()}</div>
                                <div class="title">Group1</div>
                            </div>
                        </div>
                    </div>
                    <a href="${appPath}/group1/list">
                        <div class="panel-footer">
                            <span class="pull-left">View Details</span>
                            <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                            <div class="clearfix"></div>
